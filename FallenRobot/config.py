class Config(object):
  ...
  # Optional fields
    ...
    DRAGONS = [912095781,1105084940,1205330781,862852632,1378572693,999873027,644412009,865643300,1769085034,1833664399,1276998600,1555340229,1647428346,1476128450,1734396873,2019529859,1926765024,5574601095]  # User id of sudo users
