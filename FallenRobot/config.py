...
class Config(object):
  ...
  # Get this value from my.telegram.org/apps
    ...
    DATABASE_URL = "postgres://rsuazfei:2ia__Zxinz9DUNcv_xOMDZWwL5JYfeEU@silly.db.elephantsql.com/rsuazfei"
    EVENT_LOGS = (-1001558733714)  # Event logs channel to note down important bot level events

    MONGO_DB_URI = "mongodb+srv://Dqmusic:an12if@cluster0.if5dy.mongodb.net/?retryWrites=true&w=majority"  # Get ths value from cloud.mongodb.com
