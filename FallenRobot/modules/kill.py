...
SFW_STRINGS = (
      ...
      "ഓ പിന്നെ നീ ഒക്കെ പ്രേമിക്കുമ്പോൾ അത് പ്രണയം.... നമ്മൾ ഒക്കെ പ്രേമിക്കുമ്പോൾ അത് അത്യാഗ്രഹം ...😩",
...
def qk(update, context):
    ...
    reply_text(random.choice(SFW_STRINGS))


__mod_name__ = "Killing"

Q_HANDLER = DisableAbleCommandHandler("qk", qk)
